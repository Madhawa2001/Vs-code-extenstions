 ...
 */
export async function callAiForDocumentWrapper(
  items: Item[],
  apiKey: string,
  model?: string
) {
...
// export named function with default name expected earlier
export { callAiForDocumentWrapper as callAiForDocument };
