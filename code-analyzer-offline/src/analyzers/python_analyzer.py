...
"""
python_analyzer.py
Usage: python python_analyzer.py path/to/file.py
...
def analyze(path):
    ...
    for node in tree.body:
        if isinstance(node, ast.FunctionDef):
            ...
            params = len(node.args.args) + (1 if getattr(node.args, "kwarg", None) else 0)
            ...
            items.append({
                ...
                "calls": calls,
                "snippet": snippet,
                "side_effects": []  # placeholder heuristics could be added
            })
